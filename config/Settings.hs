...
connStr :: Text
#ifdef PRODUCTION
connStr = "user=forum password=forum host=localhost port=5432 dbname=forum_production"
#else
connStr = "user=forum password=forum host=localhost port=5432 dbname=forum_debug"
#endif
